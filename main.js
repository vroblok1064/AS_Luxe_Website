  ...
  <header class="site-header" role="banner">
    <div class="container header-inner">
      ...
      <nav class="nav-links" aria-label="Main navigation">
        ...
        <a href="booking.html" ${activePage==='booking'?'class="active"':''}>Book</a>
...
function buildFloatingButtons() {
  const wa = 'https://wa.me/911234567890?text=Hi%2C%20I%27d%20like%20to%20book%20a%20consultation';
  return `
  <a href="${wa}" class="floating-wa" target="_blank" rel="noopener" aria-label="Chat on WhatsApp">💬</a>
  <div class="mobile-bar" role="navigation" aria-label="Quick actions">
    <a href="tel:+911234567890" class="mobile-bar-btn call">
      <span class="icon" aria-hidden="true">📞</span>
      <span>Call</span>
    </a>
    <a href="${wa}" target="_blank" rel="noopener" class="mobile-bar-btn wa">
      <span class="icon" aria-hidden="true">💬</span>
      <span>WhatsApp</span>
    </a>
    <a href="booking.html" class="mobile-bar-btn book">
      <span class="icon" aria-hidden="true">📅</span>
      <span>Book</span>
    </a>
  </div>`;
